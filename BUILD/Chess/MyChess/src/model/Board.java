...
public final class Board extends JPanel {
    ...
    public void getCustom_PossibleMoves(PieceType pType, PieceColor pColor, String strPos) {   
    	
    	int col, row;
    	
    	col = 7 - ('h' - strPos.charAt(0));
    	row = ('8' - strPos.charAt(1));
    	
        Piece[] placePieces = new Piece[]{           
        		pType.create(pColor)};

        int count = 0;
        for (Piece piece : placePieces) {
            if (piece != null) {
    ...
    public void getDistantPiece(PieceType pType, PieceColor pColor, String strPos){
